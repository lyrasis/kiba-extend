...
=== Added
* `yardspec` gem to support running YARD examples as RSpec tests
* Branch coverage to `simplecov` setup

=== Changed
* Tests for the `Prepend::ToFieldValue` transform converted to use `yardspec`
