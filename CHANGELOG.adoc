...
* `Marc::ExtractMeetingNameData`, `Marc::ExtractOrgNameData`, `Marc::ExtractPersonNameData`, and `Marc::ExtractNameData` transforms (PR#137, #164)
...
* `:mode` parameter to `Jobs::BaseJob` (PR#154, PR#157)
* Job duration report (added to normal and verbose job run) (PR#154, PR#157)
* `Fingerprint::FlagChanged` transform (PR#155)
* `Delete::FieldnamesStartingWith` transform (PR#156)
* `Fingerprint::MergeCorrected` transform (PR#157)
