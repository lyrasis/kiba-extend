...
RSpec.describe 'Kiba::Extend::Registry::Creator' do
  ...
  context 'with non-method creator' do
    context 'when a String' do
      ...
      it 'raises error' do
        ...
        expect{ creator }.to raise_error(Kiba::Extend::Registry::Creator::TypeError, msg)
      end
    end
    ...
    context 'when a Module not containing a `job` method, and no method given' do
      ...
      it 'raises error' do
        ...
        expect{ creator }.to raise_error(Kiba::Extend::Registry::Creator::JoblessModuleCreatorError, msg)
      end
    end
    ...
    context 'when Hash' do
      context 'with missing required key' do
        ...
        it 'raises error' do
          ...
          expect{ creator }.to raise_error(Kiba::Extend::Registry::Creator::HashCreatorKeyError, msg)
        end
      end
      ...
      context 'with callee that is not a Method or Module' do
        ...
        it 'raises error' do
          ...
          expect{ creator }.to raise_error(Kiba::Extend::Registry::Creator::HashCreatorCalleeError, msg)
        end
      end

      context 'with args that is not a Hash' do
        let(:spec) { {callee: Helpers::Project::JobbyArg, args: 'another string'} }

        it 'raises error' do
          msg = 'Registry::Creator passed Hash with String `args`. Give a Hash instead.'
          expect{ creator }.to raise_error(Kiba::Extend::Registry::Creator::HashCreatorArgsTypeError, msg)
        end
      end
  ...
  describe '#call' do
    ...
    context 'with args' do
      context 'with method' do
        let(:spec){ {callee: Helpers::Project::UnjobbyArg.method(:prep), args: {shout: true}} }
