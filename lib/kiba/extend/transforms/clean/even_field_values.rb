  ...
  module Extend
    module Transforms
      module Clean
        # @since 2.9.0
        #
        # Ensures even field values across multiple fields (i.e. a field group)
        #   by appending some value to the end of fields containing fewer
        #   values.
        #
        # See explanation of "even fields" at {Warn::UnevenFields}
        #
        # This transform appends the value of `@evener` to field values as
        ...
        #   including `warn: false` in your transform set-up.
        #
        # ## Examples
        #
        # ### Default use
        ...
        # ### Custom evener (:value)
        #
        # This setting causes the last value in the field before padding/evening
        #   the field  to be repeated as necessary to achieve evenness across
        #   fields in the group.
        #
        # Source data:
        #
        ...
        class EvenFieldValues
          ...
          #   values
          # @param treat_as_null [nil, String, Array(String)] value(s) to treat
          #   as empty when determining if the entire field is empty or not
          # @param evener [String, :value] value used to even out uneven field
          #   values. If given a String, that string will be appended to even
          #   out fields. If `:value`, the **final** value in the field needing
          #   evening will be repeated to even out the field.
          # @param delim [String] used to split/join multiple values in a field
          # @param warn [Boolean] whether to print warning of uneven fields to
          #   STDOUT
          def initialize(
            fields:,
