...
module Kiba
  module Extend
    module Registry
      # Mixin module for children of {Kiba::Extend::Registry::RegisteredFile}
      #   that other jobs depend upon
      module RequirableFile
        # Exception raised if {Kiba::Extend::FileRegistry} contains no creator
        #   for file
        class NoDependencyCreatorError < StandardError
          # @param filekey [Symbol] key for file lacking creator in
